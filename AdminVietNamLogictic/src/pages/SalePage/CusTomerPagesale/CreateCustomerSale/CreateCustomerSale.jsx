...
import { createCustomerApi } from "../../../../api/SaleAPI/CusSale/CusSaleService";
...
export default function CreateCustomerSale({
  ...
  const handleSubmit = async () => {
    try {
      ...
      const savedCustomer = await createCustomerApi({
        ...values,
        status: "ACTIVE",
      });
      ...
      <div className="create-customer-sale">
        <header className="create-customer-sale__hero">
          ...
          <div>
            ...
            <p>Tạo hồ sơ khách hàng để đội ngũ kinh doanh dễ dàng theo dõi.</p>
          </div>
        </header>
          ...
          <section className="create-customer-sale__section">
            ...
            <div className="create-customer-sale__grid">
              ...
              <Form.Item label="Trạng thái mặc định">
                <div className="create-customer-sale__fixed-status">
                  <Tag icon={<SafetyCertificateOutlined />}>
                    Đang hoạt động
                  </Tag>
                  <span>Khách hàng mới luôn được kích hoạt ngay.</span>
                </div>
