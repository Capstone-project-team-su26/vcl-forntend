import { restrictedItemsSeed } from "@/modules/restricted-items/seed";
...
const seed = {
  ...
  staffConsignments: [
    {
      ...
      receiverAddress: "12 Nguyen Hue, Q1, TP.HCM",
    ...
    },
    {
      ...
      receiverAddress: "45 Le Loi, Hai Ba Trung, Ha Noi",
      consignmentType: "CONSIGNMENT",
      status: "PENDING_REVIEW",
      createdAt: "2024-10-27T14:30:00Z",
    ...
    },
    {
      id: "CG-2024-003",
      customerName: "Le Minh C",
      receiverName: "Le Minh C",
      receiverPhone: "0987654321",
      receiverAddress: "88 Tran Phu, Da Nang",
      consignmentType: "CONSIGNMENT",
  ...
  packageConfigurations: [
    ...
    },
    {
      id: "PC-004",
      code: "CARTON-XL",
      name: "Thùng carton size XL (ngưng dùng)",
      length: 80,
      width: 50,
      height: 50,
      maxWeight: 40,
  ...
  restrictedItems: restrictedItemsSeed,
  conversations: [
    {
      id: "conv-001",
      customerId: "CUS-001",
