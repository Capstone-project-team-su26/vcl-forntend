  ...
  carriers: [
    {
      ...
      supportedCountriesRegions: ["US", "UK", "AU", "VN"],
      contactInfo: "ops@vcl.vn · +84 28 1234 5678",
      internalNotes: "Đối tác vận chuyển chính nội bộ.",
      isActive: true,
    },
    {
      id: "CAR-DHL",
      ...
      supportedCountriesRegions: ["US", "EU", "JP"],
      contactInfo: "dhl-partner@example.com",
      internalNotes: null,
      isActive: true,
    },
    {
      id: "CAR-FWD-ASIA",
      code: "FWD-ASIA",
      name: "Asia Forwarder Co.",
      carrierType: "FORWARDER",
      supportedShippingMethods: ["FREIGHT", "STANDARD"],
      supportedCountriesRegions: ["CN", "HK", "SG"],
      contactInfo: null,
      internalNotes: "Chỉ dùng cho lô hàng lớn.",
      isActive: false,
    },
  ],
