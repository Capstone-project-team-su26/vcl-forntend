  ...
  shippingMethods: [
    {
      ...
      code: "EXPRESS",
      name: "Express Air",
      description: "Giao nhanh 2–3 ngày làm việc",
      isActive: true,
      additionalServices: [
    ...
    },
    {
      ...
      code: "STANDARD",
      name: "Standard Air",
      description: "Tiêu chuẩn 5–7 ngày làm việc",
      isActive: true,
      additionalServices: [
        { id: "AS-INS", name: "Bảo hiểm hàng hóa", description: "Bảo vệ hàng đến giá trị khai báo" },
      ],
    },
    {
      ...
      code: "ECONOMY",
      name: "Economy Ground",
      description: "Tiết kiệm 7–10 ngày làm việc",
      isActive: true,
      additionalServices: [],
    },
    {
      ...
      code: "FREIGHT",
      name: "Freight",
      description: "Hàng cồng kềnh, pallet",
      isActive: false,
      additionalServices: [],
    },
  ],
