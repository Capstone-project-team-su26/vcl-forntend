      ...
      <aside className="hidden lg:flex flex-col w-64 bg-[#F9FAFB] border-r border-[#f3f4f6] fixed h-full z-30">
        <div className="h-16 flex items-center px-6 border-b border-[#f3f4f6]">
          <div className="w-8 h-8 bg-[#9ECAD6] rounded-md flex items-center justify-center mr-3">
            <img src="./assets/IMG_1.svg" alt="SwiftShip" className="w-[22px] h-[22px]" />
          </div>
      ...
      <main className="flex-1 lg:ml-64 flex flex-col min-h-screen">
        ...
        <header className="h-16 bg-white border-b border-[#f3f4f6] flex items-center justify-between px-4 lg:px-8 sticky top-0 z-20">
          ...
          <div className="flex items-center ml-auto space-x-4 lg:space-x-6">
            ...
            <div className="h-8 w-[1px] bg-[#f3f4f6] hidden sm:block" />
            <div className="flex items-center text-right">
              ...
              <div className="relative">
                <div className="w-9 h-9 rounded-full overflow-hidden bg-[#e8f9e5]">
                  <img src="./assets/IMG_8.webp" alt="Alex Henderson" className="w-full h-full object-cover" />
                </div>
                <div className="absolute bottom-0 right-0 w-2.5 h-2.5 bg-[#22C358] border-[1.5px] border-white rounded-full" />
              </div>
            </div>
          </div>
        </header>
        ...
        <div className="flex-1 p-4 lg:p-12 max-w-7xl mx-auto w-full">
          ...
          <section className="text-center mb-16">
            <h1 className="text-3xl lg:text-[48px] leading-tight font-extrabold text-[#16181D] mb-6">
              Transparent Pricing for <span className="text-[#748DAE] font-['Open_Sans']">Global Logistics</span>
            </h1>
            <p className="text-base lg:text-lg text-[#575E6B] max-w-2xl mx-auto">
          ...
          <div className="flex items-center justify-center mb-12">
            ...
            <span className="px-6 text-[10px] lg:text-xs font-bold uppercase tracking-[1.2px] text-[#575E6B]">Customize your shipment</span>
            <div className="flex-1 h-[1px] bg-[#f3f4f6]" />
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16">
            ...
            <div className="lg:col-span-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#16181D]">Additional Services</h2>
              </div>
            ...
            <div className="lg:col-span-4 space-y-6">
              {/* Coupon & Summary Card */}
              <div className="bg-[#FFEAEA]/40 border border-[#F5CBCB]/50 rounded-xl p-6 lg:p-8 shadow-sm">
                <div className="flex items-center gap-3 mb-6">
                  <img src="./assets/IMG_12.svg" alt="" className="w-5 h-5" />
                  <h3 className="text-lg font-bold text-[#16181D]">Have a Coupon?</h3>
                </div>
                ...
                <div className="flex gap-2 mb-6">
                  <input 
                    ...
                    className="flex-1 bg-white border border-[#F5CBCB]/30 rounded-lg px-3 py-2 text-sm outline-none focus:ring-1 focus:ring-[#748DAE]"
                  />
                  <button className="bg-[#748DAE] text-white px-4 py-2 rounded-lg text-sm font-bold hover:bg-[#5a7696] transition-colors">
                    Apply
                  </button>
                </div>

                <div className="border-t border-[#F5CBCB]/30 pt-6 space-y-4">
                  ...
                  <div className="border-t border-[#F5CBCB]/30 pt-4">
                    <div className="flex justify-between items-end">
                      <span className="text-lg font-bold text-[#16181D]">Est. Total</span>
                      <div className="text-right">
                        <span className="text-2xl font-black font-['Oswald'] text-[#16181D]">$24.90</span>
                        <p className="text-[10px] font-bold uppercase text-[#575E6B] tracking-tighter">Tax calculated at checkout</p>
                      </div>
                    </div>
                  </div>
                </div>

                <button className="w-full mt-8 bg-[#9ECAD6] text-white py-4 rounded-lg font-black text-sm shadow-[0_4px_8px_rgba(158,202,214,0.2)] hover:bg-[#8bb9c5] transition-all">
                  Confirm & Proceed
                </button>
          ...
          <div className="bg-[#F9FAFB] border border-[#f3f4f6] rounded-xl p-6 lg:p-8 flex flex-col md:flex-row items-center gap-6 mb-12">
            <div className="w-14 h-14 bg-[#9ECAD6]/20 rounded-full flex items-center justify-center flex-shrink-0">
              <img src="./assets/IMG_18.svg" alt="" className="w-8 h-8" />
            </div>
            <div className="flex-1 text-center md:text-left">
              <h3 className="text-xl font-bold text-[#16181D] mb-1">Need it faster than Express?</h3>
              <p className="text-sm text-[#575E6B]">Our flight service is available for critical medical or tech equipment.</p>
            </div>
            <button className="bg-white border-2 border-[#E0E2E6] px-6 py-2.5 rounded-lg text-sm font-bold text-[#16181D] hover:bg-gray-50 transition-all whitespace-nowrap">
        ...
        <footer className="bg-[#f3f4f6]/30 border-t border-[#f3f4f6] py-4 px-4 lg:px-8 mt-auto">
          <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-[#575E6B]">
            <p>© 2024 SwiftShip Logistics Inc. All rights reserved.</p>
            <div className="flex gap-6">
              <span className="cursor-pointer hover:text-[#16181D]">Support Center</span>
              <span className="cursor-pointer hover:text-[#16181D]">Terms of Service</span>
              <span className="cursor-pointer hover:text-[#16181D]">Privacy Policy</span>
            </div>
          </div>
        </footer>
      </main>
...
function NavItem({ icon, label, active = false, variant = 'default' }: { icon: string, label: string, active?: boolean, variant?: 'default' | 'danger' }) {
  ...
  const activeStyles = active ? "active-nav-item text-[#9ECAD6]" : "text-[#575E6B] hover:bg-gray-100";
  const dangerStyles = variant === 'danger' ? "text-[#D92644] hover:bg-red-50" : "";
...
function PricingCard({ tier, price, description, features, buttonText, accentColor, isBestValue = false, isHighlighted = false, buttonTextColor = 'white' }: any) {
  return (
    <div className={`relative bg-white rounded-xl p-8 flex flex-col border-2 transition-all duration-300 ${isHighlighted ? 'border-[#748DAE] shadow-lg scale-[1.02]' : 'border-[#f3f4f6] shadow-sm hover:shadow-md'}`}>
      {isBestValue && (
        <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#748DAE] text-white text-[10px] font-bold px-4 py-1 rounded-full uppercase tracking-wider">
          Best Value
        </div>
      )}
      
      <div className="text-center mb-8">
        <span className="text-xs font-bold uppercase tracking-[1.4px] text-[#575E6B] font-['Oswald']">{tier}</span>
        <div className="flex items-start justify-center mt-2">
          <span className="text-2xl font-bold font-['Oswald'] text-[#16181D] mt-1">$</span>
          <span className="text-[48px] leading-none font-black font-['Oswald'] text-[#16181D]">{price}</span>
          <span className="text-base font-medium text-[#575E6B] ml-1 self-end mb-2">/ kg</span>
        </div>
        <p className="text-sm text-[#575E6B] mt-4 leading-relaxed px-4">
          {description}
        </p>
      </div>

      <div className="flex-1 border-y border-dashed border-[#f3f4f6]/50 py-6 space-y-4 mb-8">
...
function ServiceItem({ icon, title, description, price }: { icon: string, title: string, description: string, price: string }) {
  return (
    <div className="flex items-center p-4 lg:p-6 bg-[#f3f4f6]/20 border-2 border-[#f3f4f6] rounded-xl hover:bg-[#f3f4f6]/30 transition-colors group cursor-pointer">
      <div className="w-12 h-12 bg-white border border-[#f3f4f6] rounded-lg flex items-center justify-center mr-4 flex-shrink-0 shadow-sm">
      ...
      <div className="flex-1">
        ...
        <p className="text-xs text-[#575E6B] mt-0.5">{description}</p>
      </div>
      <div className="flex items-center gap-4 ml-4">
        <span className="text-sm font-black text-[#16181D] whitespace-nowrap">{price}</span>
        <div className="w-6 h-6 rounded-full border-2 border-[#575E6B]/30 group-hover:border-[#9ECAD6] transition-colors" />
      </div>
    </div>
  );
}