...
export async function createStaffConsignmentMock(payload) {
  ...
  const entry = {
    ...
    receiverName: payload.receiverName?.trim() || customer.fullName || null,
    receiverPhone: payload.receiverPhone?.trim() || customer.phone || null,
    receiverAddress: payload.receiverAddress?.trim() || customer.address || null,
