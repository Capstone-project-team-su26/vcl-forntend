...
export default function CustomerPage() {
  ...
  return (
    <div className="flex min-h-screen bg-white font-open-sans text-ink">
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-surface border-r border-surface-muted transition-transform duration-300 lg:translate-x-0 lg:static lg:inset-0 ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"}`}
      >
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-surface-muted space-y-2">
            <button
              type="button"
              className="w-full flex items-center gap-3 px-4 py-2 text-muted hover:bg-gray-100 rounded-lg transition-colors"
            >
            ...
            <button
              type="button"
              className="w-full flex items-center gap-3 px-4 py-2 text-danger hover:bg-red-50 rounded-lg transition-colors"
            >
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
          ...
          <div className="flex items-center gap-6 ml-auto">
            ...
            <div className="flex items-center gap-3">
              <div className="text-right hidden sm:block">
                ...
                <p className="text-[12px] text-muted mt-1">Customer</p>
              </div>
              <div className="relative">
        ...
        <main className="flex-1 overflow-y-auto custom-scrollbar bg-white">
          <div className="p-4 lg:p-8 max-w-[1200px] mx-auto">{renderSection()}</div>
