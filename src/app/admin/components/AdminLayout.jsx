  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex min-h-screen bg-surface-panel font-sans text-ink", children: [
    ...
    /* @__PURE__ */ jsxs(
      "aside",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("div", { className: "px-6 py-5 border-b border-border-muted", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("div", { className: "w-9 h-9 rounded-lg bg-insight flex items-center justify-center", children: /* @__PURE__ */ jsx(Icon, { icon: "lucide:shield", className: "w-5 h-5 text-white" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-base font-bold text-insight leading-tight", children: "AdminPanel" }),
              /* @__PURE__ */ jsx("p", { className: "text-[11px] text-muted", children: "Enterprise Console" })
            ] })
          ] }) }),
