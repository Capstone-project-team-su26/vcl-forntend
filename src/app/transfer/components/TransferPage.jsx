...
function TransferPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex min-h-screen bg-white font-['Open_Sans'] text-muted", children: [
    /* @__PURE__ */ jsxs("aside", { className: "hidden lg:flex flex-col w-64 bg-surface border-r border-surface-muted fixed h-full z-30", children: [
      ...
      /* @__PURE__ */ jsxs("nav", { className: "flex-1 px-4 py-6 space-y-2", children: [
        /* @__PURE__ */ jsx(SidebarItem, { icon: "./assets/IMG_2.svg", label: "Dashboard" }),
        /* @__PURE__ */ jsx(SidebarItem, { icon: "./assets/IMG_3.svg", label: "Transfer Package", active: true }),
        /* @__PURE__ */ jsx(SidebarItem, { icon: "./assets/IMG_4.svg", label: "Track & Receive" }),
        /* @__PURE__ */ jsx(SidebarItem, { icon: "./assets/IMG_5.svg", label: "Pricing & Services" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "p-4 border-t border-surface-muted space-y-1", children: [
        /* @__PURE__ */ jsx(SidebarItem, { icon: "./assets/IMG_6.svg", label: "Settings" }),
        /* @__PURE__ */ jsx(SidebarItem, { icon: "./assets/IMG_7.svg", label: "Sign Out", variant: "danger" })
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsxs("aside", { className: `fixed inset-y-0 left-0 w-64 bg-surface z-50 transform transition-transform duration-300 lg:hidden ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"}`, children: [
      /* @__PURE__ */ jsxs("div", { className: "h-16 flex items-center px-6 border-b border-surface-muted justify-between", children: [
        /* @__PURE__ */ jsx(AppLogo, {}),
        /* @__PURE__ */ jsx("button", { onClick: () => setIsSidebarOpen(false), children: /* @__PURE__ */ jsx(Icon, { icon: "lucide:x", className: "w-6 h-6" }) })
      ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex-1 lg:ml-64 flex flex-col min-w-0", children: [
      /* @__PURE__ */ jsxs("header", { className: "h-16 bg-white border-b border-surface-muted flex items-center justify-between px-4 lg:px-8 sticky top-0 z-20", children: [
        /* @__PURE__ */ jsx("button", { className: "lg:hidden p-2", onClick: () => setIsSidebarOpen(true), children: /* @__PURE__ */ jsx(Icon, { icon: "lucide:menu", className: "w-6 h-6" }) }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center ml-auto space-x-4 lg:space-x-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsx("img", { src: "./assets/IMG_9.svg", alt: "Notifications", className: "w-5 h-5 text-ink" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center text-right", children: [
            /* @__PURE__ */ jsxs("div", { className: "mr-3 hidden sm:block", children: [
              /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-ink leading-none", children: "Alex Henderson" }),
              /* @__PURE__ */ jsx("p", { className: "text-[12px] text-muted mt-1", children: "Premium Member" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsx("img", { src: "./assets/IMG_8.webp", alt: "Avatar", className: "w-9 h-9 rounded-full object-cover border border-surface-muted" }),
              /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 right-0 w-2.5 h-2.5 bg-success border-2 border-white rounded-full" })
            ] })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("main", { className: "flex-1 p-4 lg:p-8 max-w-[1200px] mx-auto w-full", children: [
        /* @__PURE__ */ jsxs("button", { className: "flex items-center text-sm font-medium text-muted mb-6 hover:text-primary transition-colors", children: [
          /* @__PURE__ */ jsx("img", { src: "./assets/IMG_10.svg", alt: "Back", className: "w-4 h-4 mr-4" }),
          "Back to Dashboard"
        ] }),
      ...
      /* @__PURE__ */ jsx("footer", { className: "bg-surface-muted/30 border-t border-surface-muted py-4 px-4 lg:px-8 mt-auto", children: /* @__PURE__ */ jsxs("div", { className: "max-w-[1200px] mx-auto flex flex-col md:flex-row justify-between items-center gap-4 text-[12px] text-muted", children: [
        /* @__PURE__ */ jsx("p", { children: "\xA9 2024 SwiftShip Logistics Inc. All rights reserved." }),
        /* @__PURE__ */ jsxs("div", { className: "flex gap-6", children: [
          /* @__PURE__ */ jsx("a", { href: "#", className: "hover:text-primary", children: "Support Center" }),
          /* @__PURE__ */ jsx("a", { href: "#", className: "hover:text-primary", children: "Terms of Service" }),
          /* @__PURE__ */ jsx("a", { href: "#", className: "hover:text-primary", children: "Privacy Policy" })
        ] })
      ] }) })
    ] })
  ] });
}
function SidebarItem({ icon, label, active = false, variant = "default" }) {
  ...
  return /* @__PURE__ */ jsxs("button", { className: `${baseClasses} ${activeClasses} ${dangerClasses}`, children: [
    /* @__PURE__ */ jsx("img", { src: icon, alt: label, className: `w-5 h-5 ${variant === "danger" ? "text-danger" : active ? "text-primary" : "text-muted"}` }),
    label
  ] });
}
