  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen w-full flex flex-col lg:flex-row bg-white font-sans", children: [
    /* @__PURE__ */ jsxs("aside", { className: "relative hidden lg:flex lg:w-[58%] bg-surface-soft flex-col justify-between p-10 xl:p-14 overflow-hidden", children: [
      /* @__PURE__ */ jsxs("div", { className: "relative z-10", children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "inline-block px-3 py-1 mb-6 text-[10px] font-bold tracking-[0.12em] uppercase text-muted bg-white border border-border-muted rounded-full", children: "New service tiers available" }),
        /* @__PURE__ */ jsxs("h1", { className: "text-[42px] xl:text-[48px] font-bold leading-[1.15] text-ink tracking-tight max-w-[520px] mb-5", children: [
          ...
          " ",
          /* @__PURE__ */ jsx("em", { className: "text-primary italic font-normal", children: "redefined" }),
          " ",
          "for you."
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-[16px] leading-relaxed text-muted max-w-[480px] mb-10", children: "Securely manage your global shipments, track real-time deliveries, and optimize your logistics pipeline with SwiftShip's intelligent dashboard." }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative z-10 flex items-center gap-3 mt-10", children: [
        ...
        /* @__PURE__ */ jsxs("p", { className: "text-sm text-muted", children: [
          "Joined by ",
          /* @__PURE__ */ jsx("span", { className: "font-semibold text-ink", children: "12,000+" }),
    ...
    /* @__PURE__ */ jsx("main", { className: "flex-1 flex flex-col justify-center px-6 py-12 sm:px-12 lg:px-16 xl:px-20", children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-[420px] mx-auto lg:mx-0 lg:ml-auto lg:mr-auto xl:mr-16", children: [
      ...
      /* @__PURE__ */ jsxs("header", { className: "mb-8", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-[28px] font-bold text-ink tracking-tight mb-2", children: "Welcome Back" }),
        /* @__PURE__ */ jsx("p", { className: "text-[15px] text-muted", children: "Please enter your details to access your dashboard." })
      ] }),
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                ...
                /* @__PURE__ */ jsx(Link, { href: "/forgot-password", className: "text-xs font-semibold text-primary hover:text-secondary", children: "Forgot Password?" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsx(
                  Icon,
      ...
      /* @__PURE__ */ jsxs("p", { className: "mt-8 text-center text-sm text-muted", children: [
        "Don't have an account?",
        " ",
        /* @__PURE__ */ jsx(Link, { href: "/register", className: "font-bold text-primary hover:text-secondary", children: "Sign Up" })
      ] })
    ] }) })
  ] });
}
