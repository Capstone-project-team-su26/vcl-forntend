...
function ConsignmentListPanel() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("h2", { className: "text-2xl lg:text-3xl font-black tracking-tight font-['Oswald']", children: "Qu\u1EA3n l\xFD k\xFD g\u1EEDi" }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-xl shadow-[0px_2px_4px_0px_#00000012] overflow-hidden border border-surface-muted/50", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-6 py-4 border-b border-gray-50", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "overflow-x-auto custom-scrollbar", children: /* @__PURE__ */ jsxs("table", { className: "w-full min-w-[900px] text-left border-collapse", children: [
        ...
        /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-50", children: isLoading ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: 6, className: "px-6 py-12 text-center", children: /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 text-sm text-muted", children: [
      ...
      !isLoading && totalCount > 0 ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-between gap-3 px-6 py-4 border-t border-gray-50", children: [
